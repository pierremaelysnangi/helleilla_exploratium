...
export const de: Dictionary = {
  count: {
    ...
    outlets: { one: "{n} Medium", other: "{n} Medien" },
  },
  nav: {
    home: "Startseite",
    bands: "Bands",
  ...
  album: {
    ...
    ambiguousLead:
      "Mehrere Bands haben unter diesem Namen veröffentlicht. Wähle die gesuchte aus.",
  },
  releaseType: {
    album: "Album",
    ep: "EP",
  ...
  festival: {
    ...
    lead: "Wo sich die Szene trifft: {venues}, {countries}. Termine und Tickets liegen bei den Veranstaltenden — diese Seite listet sie nur auf.",
    since: "seit {year}",
    until: "bis {year}",
    festival: "Festival",
    venue: "Spielstätte",
  ...
  meta: {
    ...
    pressDescription:
      "Presse und Medien der Metal-Szene, Land für Land, mit Link zu jeder Redaktion.",
  },
  console: {
    title: "Einen Moment.",
  ...
  press: {
    ...
    lead: "Wer über diese Musik schreibt: {outlets}, {countries}. Wir verweisen dorthin und übernehmen nichts — ein Artikel gehört dem, der ihn geschrieben hat.",
    visit: "Lesen",
    notice:
      "Diese Liste erhebt keinen Anspruch, die Metal-Presse abzudecken; sie bietet Einstiege, deren Adresse geprüft wurde.",
  },
  outletKind: {
    webzine: "Webzine",
    magazine: "Magazin",
