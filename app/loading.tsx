/**
 * État de chargement global (route /).
 * Affiché automatiquement par Next.js pendant un chargement au niveau racine :
 * un squelette (skeleton) avec animation "pulse" imitant la structure d'une page.
 */
